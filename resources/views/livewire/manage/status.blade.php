...
<form wire:submit.prevent="storeStatusData">

    <div class="form-group row">
        <label for="statname" class="col-3">Name</label>
        <div class="col-9">
            <input type="text" name="statname" id="statname" class="form-control" wire:model="statname">
            @error('statname')
    ...
    <div class="form-group row">
        ...
        <div class="col-9">
            <input type="text" name="description" id="description" class="form-control" wire:model="description">
            @error('description')
                <span class="text-danger" style="font-size: 11.5px;">{{ $message }}</span>
            @enderror
        </div>
