                    ...
                    <!-- offcanvas-logo-start -->
                     <div class="offcanvas-logo">
                        <div class="homec-header__logo">
                            <a href="index.html"><img src="{{ url('mdd/front/img/logo.png') }}" alt="#"></a>
                        </div>
                    </div>
                    <!-- offcanvas-logo-end -->
                    ...
                    <nav id="offcanvas-menu" class="offcanvas-menu">
                        ...
                        <ul class="nav-menu menu navigation list-none">
                            ...
                            <li class="menu-item-has-children"><a href="#">Agents</a>
                                <ul class="sub-menu">
                                    <li><a href="our-agent.html">Our Agent</a></li>
                                ...
                                <ul class="homec-header__list">
                                    <li>
                                        <a href="mailto:HomeC34@gmail.com">
                                            <img src="{{ url('mdd/front/img/email-icon.svg') }}" alt="#">
                                            <span>info@mdd-properties.com/</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="tel:+00239040248">
                                            <img src="{{ url('mdd/front/img/phone-icon.svg') }}" alt="#">
                                            <span>+00 123 0248</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="mailto:HomeC34@gmail.com">
                                            <img src="{{ url('mdd/front/img/locations-icon.svg') }}" alt="#">
                                            <span>123 St. Marikina City, Philippines</span>
                                        </a>
                                    </li>
                                </ul>
                                <!-- End Contact -->
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                </g><defs><clipPath id="clip0_11"><rect width="24" height="24"/></clipPath></defs>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                </g><defs><clipPath id="clip0_22"><rect width="24.0001" height="24"/></clipPath></defs>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                </g><defs><clipPath id="clip0_33"><rect width="23.9531" height="24"/></clipPath></defs>
                                            </svg>
                                        </a>
                                    </li>
                                </ul>
    ...
    <li class="menu-item-has-children"><a href="#">Account</a>
     ...
     @endauth
                                ...
                                <div class="homec-header__button">
                                    @if (Route::has('iologin'))

                                        @auth
                                            <p>Hi, {{ Auth::user()->name }} </p>
                                            <form method="POST" action="{{ route('iologout_attemp') }}">
                                                @csrf
                                                <button type="submit" class="homec-btn">Logout</button>
                                            </form>

                                        @else 

                                            @if (Route::has('ioregister'))
                                                <a href="{{ route('ioregister') }}">Register </a>
                                            @endif

                                            <a href="{{ route('iologin') }}" class="homec-btn"><span>Login</span></a>
