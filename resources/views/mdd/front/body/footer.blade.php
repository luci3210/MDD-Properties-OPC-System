<!-- Footer -->
        <footer class="footer-area p-relative">
            <div class="homec-shape">
                <div class="homec-shape-single homec-shape-10"><img src="img/anim-shape-6.svg" alt="#"></div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="homec-form mg-top-100">
                            <div class="homec-form__content">
                                <span class="homec-form__label">For Rant house offer</span>
                                <h3 class="homec-form__title">Join Homec  Community</h3>
                            </div>
                            <form class="homec-form__form">
                                <input type="email" name="Email" placeholder="Enter your email address" required="">
                                <button type="submit" class="homec-btn"><span>Subscribe Now</span></button>
                            </form>
                        </div>
                        <!-- End Subscribe Form -->
                    </div>
                                ...
                                <div class="col-lg-4 col-md-3 col-12">
                                    ...
                                    <div class="footer-about-widget">
                                        <div class="footer-logo homec-header__logo">
                                            <a class="logo" href="index.html"><img src="img/logo-footer.png" alt="#"></a>
                                        </div>
                                        <p class="footer-about-text">There are many variatons of pass Ipsum available, but the majority alteration in some form, by inject randomised words</p>
                                        <!-- Social -->
                                            ...
                                            <li>
                                                <a href="#">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        </g><defs><clipPath id="clip0_1"><rect width="24" height="24"/></clipPath></defs>
                                                    </svg>
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        </g><defs><clipPath id="clip0_2"><rect width="24.0001" height="24"/></clipPath></defs>
                                                    </svg>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        </g><defs><clipPath id="clip0_3"><rect width="23.9531" height="24"/></clipPath></defs>
                                                    </svg>
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            ...
                                            <div class="single-widget footer-useful-links">
                                                <h3 class="widget-title">Listing</h3>
                                                <ul class="f-useful-links-inner list-none">
                                                    <li><a href="property-grid.html"><i class="fa-solid fa-minus"></i>Properties</a></li>
                                                    <li><a href="add-property.html"><i class="fa-solid fa-minus"></i>Add Properties</a></li>
                                                    <li><a href="submit-property.html"><i class="fa-solid fa-minus"></i>Submit Property</a></li>
                                                    <li><a href="login.html"><i class="fa-solid fa-minus"></i>Login</a></li>
                                                    <li><a href="signup.html"><i class="fa-solid fa-minus"></i>Signup</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Footer Widget -->
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
                                            ...
                                            <div class="single-widget footer-need-helps">
                                                <h3 class="widget-title">Importants</h3>
                                                <ul class="f-need-helps-inner list-none">
                                                    <li><a href="about.html"><i class="fa-solid fa-minus"></i>About Us</a></li>
                                                    <li><a href="pricing.html"><i class="fa-solid fa-minus"></i>Pricing</a></li>
                                                    <li><a href="blog.html"><i class="fa-solid fa-minus"></i>Blog</a></li>
                                                    <li><a href="faq.html"><i class="fa-solid fa-minus"></i>Faq's</a></li>
                                                    <li><a href="contact-us.html"><i class="fa-solid fa-minus"></i>Contact Us</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Footer Widget -->
                                        </div>
                                            ...
                                            <div class="single-widget footer-contact">
                                                ...
                                                <div class="f-contact__form-top">
                                                    <ul class="f-contact-list list-none">
                                                        <li><img src="img/footer-phone.svg" alt="#"><a href="tel:+(323)750-1234">+(323) 750-1234</a></li>
                                                        <li><img src="img/footer-message.png" alt="#"><a href="mailto:infoyour@gmail.com">infoyour@gmail.com</a></li>
                                                        <li><img src="img/footer-location.png" alt="#"><p>374 FA Tower, William S Blvd 2721, IL, USA</p></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <!-- End Footer Widget -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <!-- Copyright Text -->
                            <p class="copyright-text">© 2023 Homeco. All rights reserved by <a href="#" target="_blank">QuomodoTheme</a></p>
                        </div>
                        <div class="col-lg-6 col-12">
                            <!-- Footer Page List -->
