...
@section('content')
		<!-- homec Hero -->
		<section id="hero" class="homec-hero homec-hero__v2 p-relative" style="background-image:url('img/map.svg');">
			<div class="container">
					...
					<div class="col-12">
						<div class="homec-hero__inner homec-hero__inner--v2">
							...
							<div class="homec-hero__content homec-hero__content--v2">
								<h1 class="homec-hero__title">Get your <span class="homec-hero__title--focus" style="background-image:url('img/shape-2.svg')">Property</span> With Agents.</h1>
								<ul class="homec-iconic-list homec-iconic-list__v2 homec-iconic-list__white list-none mg-top-30">
									...
									<li><i class="fa-solid fa-check"></i>Best real house and property for your dream.</li>
								</ul>
								<a href="property-grid.html" class="homec-btn homec-btn__second"><span>See all Property</span></a>
							</div>
							<!-- End Hero Content -->
										...
										<div class="swiper-slide">
											...
											<a href="property-single.html" class="homec-property homec-property__card">
												...
												<div class="homec-property__head">
													...
													<img src="https://placehold.co/495x500" alt="#">
												</div>
												<!-- Property Body-->
												<div class="homec-property__body">
													<div class="homec-property__body--inside">
														...
														<h3 class="homec-property__title">Modern House With Pool</h3>
														<div class="homec-property__text">
															<img src="img/location-icon2.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
														</div>
														<!-- Property List-->
														<ul class="homec-property__list homec-border-top list-none">
															<li><img src="img/room-icon2.svg" alt="#">3 Room</li>
															<li><img src="img/bath-icon2.svg" alt="#">2 Bathroom</li>
															<li><img src="img/size-icon2.svg" alt="#">5x9 m2</li>
														</ul>
													</div>
												</div>
											</a>
										...
										<div class="swiper-slide">
											...
											<a href="property-single.html" class="homec-property homec-property__card">
												...
												<div class="homec-property__body">
													<div class="homec-property__body--inside">
														<div class="homec-property__price">$3,976 <span>/month</span></div>
														<h3 class="homec-property__title">Diamond Mn Apartment</h3>
														<div class="homec-property__text">
															<img src="img/location-icon2.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
														</div>
														<!-- Property List-->
										...
										<div class="swiper-slide">
											...
											<a href="property-single.html" class="homec-property homec-property__card">
												...
												<div class="homec-property__body">
													<div class="homec-property__body--inside">
														<div class="homec-property__price">$3,976 <span>/month</span></div>
														<h3 class="homec-property__title">Northwest Office Space</h3>
														<div class="homec-property__text">
															<img src="img/location-icon2.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
														</div>
														<!-- Property List-->
			...
			<div class="container homec-listing__container">
				<div class="row">
					<div class="col-12">
						...
						<div class="homec-section__head text-center mg-btm-60">
							<span class="homec-section__badge homec-primary-color homec-section__badge--small m-0"  data-aos="fade-in" data-aos-delay="300">View All 329 New Listings</span>
							<h2 class="homec-section__title"  data-aos="fade-in" data-aos-delay="400">Explore a Neighborhood or City</h2>
						</div>
						<!-- Homec Search -->
							...
							<form class="homec-search-form__form homec-search-form__form--city">
								<div class="homec-search-form__group">
									...
									<div class="form-group">
										<select>
											<option data-display="Apartment">Select Location</option>
						...
						<div class="homec-listing mg-top-40">
							...
							<div class="homec-listing__single">
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x567" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>Hong Kong</h4>
									</a>
								</div>
							</div>
							...
							<div class="homec-listing__single">
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x221" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>Boston</h4>
									</a>
								</div>
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x316" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>New Castle</h4>
									</a>
								</div>
							</div>
							<!-- End Homec Single Listing -->
							...
							<div class="homec-listing__single">
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x576" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>Tokyo</h4>
									</a>
								</div>
							</div>
							<!-- End Homec Single Listing -->
							...
							<div class="homec-listing__single">
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x312" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>Tunsiya</h4>
									</a>
								</div>
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x224" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>Iran</h4>
									</a>
								</div>
							</div>
							<!-- End Homec Single Listing -->
							...
							<div class="homec-listing__single">
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x221" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>Rome</h4>
									</a>
								</div>
								<div class="homec-listing__inner">
									<a href="#">
										<img src="https://placehold.co/274x316" alt="#">
										<div class="homec-overlay homec-listing__overlay"></div>
										<h4 class="homec-listing__title"><span>4+ Listing</span>Dhaka</h4>
									</a>
								</div>
							</div>
							<!-- End Homec Single Listing -->
				...
				<div class="row">
					<div class="col-12  d-flex justify-content-center mg-top-40" data-aos="fade-up" data-aos-delay="700">
						<!-- Section TItle -->
						<a href="#" class="homec-btn"><span>See all  City</span></a>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="homec-about homec-bg-third-color pd-top-90 pd-btm-120">
			<div class="homec-shape">
				<div class="homec-shape-single homec-shape-1"><img src="img/anim-shape-1.svg" alt="#"></div>
				<div class="homec-shape-single homec-shape-2"><img src="img/anim-shape-2.svg" alt="#"></div>
				<div class="homec-shape-single homec-shape-3"><img src="img/anim-shape-3.svg" alt="#"></div>
				<div class="homec-shape-single homec-shape-4"><img src="img/anim-shape-1.svg" alt="#"></div>
				<div class="homec-shape-single homec-shape-5"><img src="img/anim-shape-2.svg" alt="#"></div>
				<div class="homec-shape-single homec-shape-6"><img src="img/anim-shape-3.svg" alt="#"></div>
			</div>
			<div class="container">
				<div class="row align-items-center">
						...
						<div class="homec-image-group homec-image-group--v2">
							<div class="homec-image-group__main">
								...
								<div class="homec-experiences">
									<h4 class="homec-experiences__title">12 Years <span>Experience</span></h4>
								</div>
							</div>
							<div class="homec-ceo-quote">
								...
								<h4 class="homec-ceo-quote__title">Wade De Warren<span>Homec Ceo & Founder</span></h4>
							</div>
						</div>
						...
						<div class="homec-about-content homec-about-content--v2">
							...
							<div class="homec-section__head">
								<div class="homec-section__shape">
									<span class="homec-section__badge homec-section__badge--shape" style="background-image:url('img/section-shape.svg')" data-aos="fade-down" data-aos-delay="300">About Homeco</span>
								</div>
								<h2 class="homec-section__title" data-aos="fade-in" data-aos-delay="400">Have done some Coo Stuff with common users</h2>
							</div>
							<div class="homec-about-content__inner mg-top-20" data-aos="fade-in" data-aos-delay="500">
								<p class="homec-about-content__text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
								...
								<div class="homec-dflex-space">
									<div class="homec-funfact__single homec-funfact__single--v2">
										<div class="homec-funfact__icon">
											<img src="img/count-icon1.svg" alt="#">									
										</div>
										<h3 class="homec-funfact__number"><span class="counter">90</span>k+ Renters</h3>
										<p class="homec-funfact__text">believe in our service & Care</p>
									</div>
									<div class="homec-funfact__single homec-funfact__single--v2">
										<div class="homec-funfact__icon">
											<img src="img/count-icon2.svg" alt="#">								
										</div>
										<h3 class="homec-funfact__number"><span class="counter">120</span>k+ Renters</h3>
										<p class="homec-funfact__text">house ready for cccupancy</p>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- Properties Listing -->
		<section class="homec-properties homec-bg-cover  pd-top-120 pd-btm-120" style="background-image: url('img/bg-shape-four.svg');">
			<div class="homec-shape">
				<div class="homec-shape-single homec-shape-7"><img src="img/anim-shape-4.svg" alt="#"></div>
				<div class="homec-shape-single homec-shape-8"><img src="img/anim-shape-5.svg" alt="#"></div>
			</div>
			<div class="container">
				<div class="row">
					<div class="col-12">
						...
						<div class="homec-section__head text-center section-white mg-btm-30">
							<span class="homec-section__badge homec-section__badge--small homec-primary-color  m-0" data-aos="fade-in" data-aos-delay="300">View All 329 New Listings</span>
							<h2 class="homec-section__title" data-aos="fade-in" data-aos-delay="400">Latest Properties</h2>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-up" data-aos-delay="400">
						...
						<div class="homec-property">
							<!-- Property Head-->
							<div class="homec-property__head">
								<img src="https://placehold.co/350x220" alt="#">
								<!-- Top Sticky -->
								<div class="homec-property__hsticky">
									...
									<a href="agent-detail.html" class="homec-property__asticky">
										...
										<h4 class="homec-property__asticky--label">Wade Wirren<span>Agent</span></h4>
									</a>
								</div>
								<!-- End Top Sticky -->
							</div>
							...
							<div class="homec-property__body">
								...
								<h3 class="homec-property__title"><a href="property-single.html">Northwest Office Space</a></h3>
								<div class="homec-property__text">
									<img src="img/location-icon.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
								</div>
								<!-- Property List-->
								<ul class="homec-property__list homec-border-top list-none">
									<li><img src="img/room-icon.svg" alt="#">3 Room</li>
									<li><img src="img/bath-icon.svg" alt="#">2 Bathroom</li>
									<li><img src="img/size-icon.svg" alt="#">5x9 m2</li>
								</ul>
							</div>
						</div>
						<!-- End Single property-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30"  data-aos="fade-up" data-aos-delay="600">
						...
						<div class="homec-property">
							...
							<div class="homec-property__body">
								...
								<h3 class="homec-property__title"><a href="property-single.html">Countryside Lake View...</a></h3>
								<div class="homec-property__text">
									<img src="img/location-icon.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
								</div>
								<!-- Property List-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-up" data-aos-delay="800">
						...
						<div class="homec-property">
							...
							<div class="homec-property__body">
								...
								<h3 class="homec-property__title"><a href="property-single.html">Brand New Shopping Mall</a></h3>
								<div class="homec-property__text">
									<img src="img/location-icon.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
								</div>
								<!-- Property List-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-up" data-aos-delay="400">
						...
						<div class="homec-property">
							...
							<div class="homec-property__body">
								...
								<h3 class="homec-property__title"><a href="property-single.html">Affordable Green Villa House</a></h3>
								<div class="homec-property__text">
									<img src="img/location-icon.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
								</div>
								<!-- Property List-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30"  data-aos="fade-up" data-aos-delay="600">
						...
						<div class="homec-property">
							...
							<div class="homec-property__body">
								...
								<h3 class="homec-property__title"><a href="property-single.html">Diamond Manco Apartment</a></h3>
								<div class="homec-property__text">
									<img src="img/location-icon.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
								</div>
								<!-- Property List-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-up" data-aos-delay="800">
						...
						<div class="homec-property">
							...
							<div class="homec-property__body">
								...
								<h3 class="homec-property__title"><a href="property-single.html">Countryside Modern Lake</a></h3>
								<div class="homec-property__text">
									<img src="img/location-icon.svg" alt="#"><p>1901 Thornridge Cir. Shiloh, Hawaii 81063</p>
								</div>
								<!-- Property List-->
				...
				<div class="row">
					<div class="col-12  d-flex justify-content-center mg-top-40"  data-aos="fade-up" data-aos-delay="600">
						<!-- Section TItle -->
						<a href="#" class="homec-btn"><span>See all  Properties</span></a>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="homec-bg-primary-color pd-top-110 pd-btm-110">
			<div class="homec-bg homec-bg__opacity" style="background-image: url(img/features-list-bg.svg);"></div>
			<div class="container">
				<div class="row">
					<div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-12 mg-btm-40">
						<div class="homec-section__head section-white text-center">
							<p class="text-white"  data-aos="fade-in" data-aos-delay="300">4 step to go</p>
							<h2 class="homec-section__title"  data-aos="fade-in" data-aos-delay="400">Why Choose us</h2>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="homec-features-list">
							...
							<div class="homec-features-list__single" data-aos="fade-up" data-aos-delay="400">
								...
								<div class="homec-features-list__body">
									<h4 class="homec-features-list__title">Trusted </h4>
									<p class="homec-features-list__text">believe in our service & Care</p>
								</div>
							</div>
							<!-- End Features Single -->
							<!-- Features Single -->
							<div class="homec-features-list__single"  data-aos="fade-up" data-aos-delay="600">
								<div class="homec-features-list__head">
									<div class="homec-features-list__first">
										<div class="homec-features-list__icon">
											<img src="img/support-icon.svg" alt="#">
										</div>
										<h4 class="homec-features-list__number" >02</h4>
									</div>
								...
								<div class="homec-features-list__body">
									<h4 class="homec-features-list__title">24/7 Support</h4>
									<p class="homec-features-list__text">believe in our service & Care</p>
								</div>
							</div>
							<!-- End Features Single -->
							<!-- Features Single -->
							<div class="homec-features-list__single"  data-aos="fade-up" data-aos-delay="800">
								<div class="homec-features-list__head">
									<div class="homec-features-list__first">
										<div class="homec-features-list__icon">
											<img src="img/finance-icon.svg" alt="#">
										</div>
										<h4 class="homec-features-list__number" >03</h4>
									</div>
								...
								<div class="homec-features-list__body">
									<h4 class="homec-features-list__title">Financing Easy</h4>
									<p class="homec-features-list__text">believe in our service & Care</p>
								</div>
							</div>
							<!-- End Features Single -->
							<!-- Features Single -->
							<div class="homec-features-list__single"  data-aos="fade-up" data-aos-delay="1000">
								<div class="homec-features-list__head">
									<div class="homec-features-list__first">
										<div class="homec-features-list__icon">
											<img src="img/wide-house-icon.svg" alt="#">
										</div>
										<h4 class="homec-features-list__number" >04</h4>
									</div>
								</div>
								<div class="homec-features-list__body">
									<h4 class="homec-features-list__title">Wide Range House</h4>
									<p class="homec-features-list__text">believe in our service & Care</p>
								</div>
							</div>
							<!-- End Features Single -->
				...
				<div class="row">
					<div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-12">
						<div class="homec-section__head text-center mg-btm-30">
							<span class="homec-section__badge homec-section__badge--small homec-primary-color  m-0" data-aos="fade-in" data-aos-delay="300">View All 234  Agent</span>
							<h2 class="homec-section__title" data-aos="fade-in" data-aos-delay="400">Meet Properties Agents</h2>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-in" data-aos-delay="400">
						...
						<div class="homec-agent homec-agent__v2">
							...
							<div class="homec-agent__head">
								<img src="https://placehold.co/285x295" alt="#">
							</div>
							<!-- Agent Body -->
							<div class="homec-agent__body">
								<a class="homec-agent__body--btn" href="agent-detail.html">See Properties</a>
								<ul class="homec-agent__social list-none">
									...
									<li>
										<a href="#"><svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<h4 class="homec-agent__title"><a href="agent-single.html">Floyd Miles<span>Real Estate Broker</span></a></h4>
							</div>
							<!-- End Agent Body -->
						</div>
						<!-- End Single agent-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30"  data-aos="fade-in" data-aos-delay="500">
						...
						<div class="homec-agent homec-agent__v2">
							...
							<div class="homec-agent__body">
								...
								<h4 class="homec-agent__title"><a href="agent-single.html">Robert Fox<span>Real Estate Broker</span></a></h4>
							</div>
							<!-- End Agent Body -->
						</div>
						<!-- End Single agent-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-in" data-aos-delay="600">
						...
						<div class="homec-agent homec-agent__v2">
							...
							<div class="homec-agent__body">
								...
								<h4 class="homec-agent__title"><a href="agent-single.html">Dianne Russell<span>Real Estate Broker</span></a></h4>
							</div>
							<!-- End Agent Body -->
						</div>
						<!-- End Single agent-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-in" data-aos-delay="700">
						...
						<div class="homec-agent homec-agent__v2">
							...
							<div class="homec-agent__body">
								...
								<h4 class="homec-agent__title"><a href="agent-single.html">Esther Howard<span>Real Estate Broker</span></a></h4>
							</div>
							<!-- End Agent Body -->
						</div>
						<!-- End Single agent-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-in" data-aos-delay="800">
						...
						<div class="homec-agent homec-agent__v2">
							...
							<div class="homec-agent__body">
								...
								<h4 class="homec-agent__title"><a href="agent-single.html">Devon Lane<span>Real Estate Broker</span></a></h4>
							</div>
							<!-- End Agent Body -->
						</div>
						<!-- End Single agent-->
					...
					<div class="col-lg-4 col-md-6 col-12 mg-top-30" data-aos="fade-in" data-aos-delay="900">
						...
						<div class="homec-agent homec-agent__v2">
							...
							<div class="homec-agent__body">
								...
								<h4 class="homec-agent__title"><a href="agent-single.html">Wade Warren<span>Real Estate Broker</span></a></h4>
							</div>
							<!-- End Agent Body -->
						</div>
						<!-- End Single agent-->
		...
		<!-- Faq Area -->
		<section class="homec-bg-cover pd-top-90 pd-btm-120" style="background-image: url('img/bg-shape-five.svg');" >
			<div class="container homec-container-medium">
				<div class="row homec-container-medium__row align-items-center">
					<div class="col-lg-6 col-md-6 col-12 mg-top-30" data-aos="fade-up" data-aos-delay="400">
						<div class="homec-section__head">
							<div class="homec-section__shape">
								<span class="homec-section__badge homec-section__badge--shape homec-section__badge--shape--v2" style="background-image:url('img/shape-3.svg')">FAQ</span>
							</div>
							<h2 class="homec-section__title">If you  want to know Frequently Ask Questions</h2>
						</div>
						<div class="homec-accordion accordion accordion-flush" id="homec-accordion">
							...
							<div class="accordion-item homec-accordion__single mg-top-30">
								<h2 class="accordion-header" id="homect-1">
									<button class="accordion-button collapsed homec-accordion__heading" type="button" data-bs-toggle="collapse" data-bs-target="#ac-collapse1">What are we for it Company?</button>
								</h2>
								<div id="ac-collapse1" class="accordion-collapse collapse"  data-bs-parent="#homec-accordion">
									<div class="accordion-body homec-accordion__body">From the first year of primary school, we provide interactive and one-to-one online trainings for our children to enjoy  the first year of primary school, we provide interactive and one-to-one online trainings.</div>
								</div>
							</div>
							<!-- End Single Accordion -->
							...
							<div class="accordion-item homec-accordion__single active mg-top-30">
								<h2 class="accordion-header" id="homect-3">
									<button class="accordion-button   homec-accordion__heading" type="button" data-bs-toggle="collapse" data-bs-target="#ac-collapse2" >What happens if you delete social media apps?</button>
								</h2>
							...
							<div class="accordion-item homec-accordion__single mg-top-30">
								<h2 class="accordion-header" id="homect-2">
									<button class="accordion-button collapsed  homec-accordion__heading" type="button" data-bs-toggle="collapse" data-bs-target="#ac-collapse3" aria-expanded="false">What is social media in simple words?</button>
								</h2>
							...
							<div class="accordion-item homec-accordion__single mg-top-30">
								<h2 class="accordion-header" id="homect-4">
									<button class="accordion-button collapsed homec-accordion__heading" type="button" data-bs-toggle="collapse" data-bs-target="#ac-collapse4" >What is social media in simple words?</button>
								</h2>
		...
		<!-- Blog Area -->
		<section id="blog" class="blog-area homec-bg-cover section-padding" style="background-image: url('img/bg-shape-two.svg');">
			<div class="blog-bg-pattern">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
							<div class="homec-section__head text-center mg-btm-30">
								<span class="homec-section__badge homec-primary-color homec-section__badge--small m-0" data-aos="fade-in" data-aos-delay="300">Get our Information </span>
						...
						<div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
							...
							<div class="homec-blog">
								<div class="homec-blog__head">
									...
									<a href="blog-single.html"><img src="https://placehold.co/345x260" alt="#"></a>
									<!-- Blog Content -->
									<div class="homec-blog__content">
										<ul class="homec-blog__meta list-none">
											...
											<li class="active">
												...
												<a href="#">By Abdullah Mamun</a>
											</li>
										</ul>
										<h3 class="homec-blog__title"><a href="blog-single.html">Search For House Rent in a Property For Rent end.</a></h3>
										<div class="home-blog__button homec-border-top">
											<a href="blog-single.html" class="homec-blog__btn">Read More
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
