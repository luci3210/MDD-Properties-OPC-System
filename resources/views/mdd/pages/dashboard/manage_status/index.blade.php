...
@include('mdd.pages.dashboard.manage_status.status_form_modal')
                ...
                <div class="drodown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" style="">
                        <ul class="link-list-opt no-bdr">
                            <li><a data-bs-toggle="modal" href="#statusform"><span>Add new Status</span></a></li>
                        </ul>
                    </div>
                </div>
            </li>
...
<table class="table table-tranx">
    <thead>
        <tr class="tb-tnx-head">
            ...
            <th class="tb-tnx-id"><strong>Name</strong></th>
            <th class="tb-tnx-id"><strong>Description</strong></th>
